...
export default function EnhancedAmbulanceDashboard() {
  ...
  // Auto-update location every 30 seconds when active
  useEffect(() => {
    if (location && ambulanceProfile?.id && (activeRequest || journeyActive)) {
  ...
  }, [location, ambulanceProfile?.id, activeRequest, journeyActive]);
